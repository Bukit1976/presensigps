...
@section('content')
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" id="dari" value="" class="form-control" name="dari"
                                        placeholder="Dari">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" id="sampai" value="" class="form-control" name="sampai"
                                        placeholder="Sampai">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-3">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" id="nik" value="{{ Request('nik') }}" class="form-control"
                            ...
                            @foreach ($izinsakit as $d)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <span class="badge bg-warninb">Pending</span>
                                        @endif
                                    </td>
                                    <td>
    ...
    <div class="modal modal-blur fade" id="modal-izinsakit" tabindex="-1" style-display="none" role="dialog"
        aria-hidden="true">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <select name="status_approved" id="status_approved" class="form-select">
                                        ...
                                        <option value="2" class="">Ditolak</option>
                                    </select>
                                </div>
                            </div>
                        </div>
