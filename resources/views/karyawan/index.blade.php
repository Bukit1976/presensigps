...
@section('content')
    ...
    <!-- Modal -->
    <div class="modal modal-blur fade" id="modal-inputkaryawan" tabindex="-1" style-display="none" role="dialog"
        aria-hidden="true">
                            ...
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    <span class="input-icon-addon">
                                        <!-- Download SVG icon from http://tabler-icons.io/i/user -->
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="icon icon-tabler icon-tabler-phone-check" width="24"
                                            height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                                            fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                            <path
    ...
    {{-- Modal Edit --}}
    <div class="modal modal-blur fade" id="modal-editkaryawan" tabindex="-1" style-display="none" role="dialog"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
