...
@section('content')
    ...
    <!-- Modal -->
    <div class="modal modal-blur fade" id="modal-inputdepartemen" tabindex="-1" style-display="none" role="dialog"
        aria-hidden="true">
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" id="kode_dept" value="" class="form-control"
    ...
    {{-- Modal Edit --}}
    <div class="modal modal-blur fade" id="modal-editdepartemen" tabindex="-1" style-display="none" role="dialog"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
        ...
        $(function() {
            ...
            $("#frmdepartemen").submit(function() {
                ...
                if (kode_dept == "") {
                    Swal.fire({
                        title: 'Warning!',
                        text: 'Kolom departemen Tidak Boleh Kosong',
                        icon: 'warning',
